...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center text-center px-4 sm:px-6 md:px-12 pt-24 sm:pt-28 md:pt-32 pb-8 sm:pb-12 overflow-hidden">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="relative z-10 flex flex-col justify-between items-center max-w-5xl mx-auto w-full flex-1">
        ...
        {/* Top Section */}
        <div className="space-y-6 sm:space-y-8 mt-4 md:mt-12 animate-[fadeInDown_1s_ease-out]">
        ...
        <div className="flex flex-col items-center space-y-6 sm:space-y-10 mt-auto animate-[fadeInUp_1s_ease-out] w-full pb-4 sm:pb-8 pt-8 sm:pt-16">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-5 sm:gap-x-10 gap-y-4 sm:gap-y-6 max-w-3xl pt-2">
            {SOCIAL_LINKS.map((social) => (
              ...
              >
                <social.icon size={18} className="group-hover:scale-110 transition-transform shrink-0 sm:[width:22px] sm:[height:22px]" />
